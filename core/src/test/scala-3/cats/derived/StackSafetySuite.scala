...
object StackSafetySuite:
  ...
  object eqInst:
    given Eq[IList[Int]] = stackSafe.semiauto.eq

  object orderInst:
    given Order[IList[Int]] = stackSafe.semiauto.order

  object pOrderInst:
    given PartialOrder[IList[Int]] = stackSafe.semiauto.partialOrder

  object hashInst:
    given Hash[IList[Int]] = stackSafe.semiauto.hash

  object showInst:
    given Show[IList[Int]] = stackSafe.semiauto.show

  object invariantInst:
    given Invariant[EnumK1] = stackSafe.semiauto.invariant

  object foldableInst:
    given Foldable[EnumK1] = stackSafe.semiauto.foldable

  object traverseInst:
    given Traverse[EnumK1] = stackSafe.semiauto.traverse

  object reducibleInst:
    given Reducible[EnumK1] = stackSafe.semiauto.reducible

  object netInst:
    given NonEmptyTraverse[EnumK1] = stackSafe.semiauto.nonEmptyTraverse
